...
<div style="display: flex; justify-content: center; gap: 15px;">
    <img src={import.meta.env.BASE_URL+'/'+"wiki/images/library/Example Script 1.png"} alt="Freeplay."         title="Freeplay."         style="width:50%;"/>
    <img src={import.meta.env.BASE_URL+'/'+"wiki/images/library/Example Script 2.png"} alt="Yes, this is UGH." title="Yes, this is UGH." style="width:50%;"/>
</div>
</details>
