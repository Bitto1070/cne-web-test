...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/start.png"} alt="Song Info popup menu" height="450"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/makesong.png"} alt="Song Info popup menu"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/importsource.png"} alt="Import Source"/>
</div>

Next, you have to import the audio files. This step can be skipped if you selected `V-Slice Project`.
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/importsounds.png"} alt="Add Audios"/>
</div>

Finally, you need to import the song's data.
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/importdata.png"} alt="Add Data"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/menudata.png"} alt="Menus Data popup menu"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/songmade.png"} alt="Initial screen of the chart editor, now with the added song" height="450"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/newchart.png"} alt="New Chart menu"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/addvariation.png"} alt="New Variation menu"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/charterinitial.png"} alt="Chart Editor" height="450"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/events/local.png"} alt="Add Local Event"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/events/noevent.png"} alt="No Event"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/events/addevent.png"} alt="Add Event"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/events/eventexample.png"} alt="Top Bar"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar.png"} alt="Top Bar" style="width: 100%;"/>
</div>
...
<h3>File</h3>
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/file.png"} alt="Top Bar - File"/>
</div>
...
<h3>Edit</h3>
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/edit.png"} alt="Top Bar - Edit"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/chart.png"} alt="Top Bar - Chart"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/view.png"} alt="Top Bar - View"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/song.png"} alt="Top Bar - Song"/>
</div>
...
- `Instrumental`, `Voices` and `Hitsounds` let you control the volume of those sounds. You can either change them by dragging the bar, or mute/unmute them by clicking the <img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/speaker.png"}/> speaker icon.

<h3>Note</h3>

<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/note.png"} alt="Top Bar - Song"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/notetypes.png"} alt="Notetypes submenu"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/topbar/default-notes.png"} alt="The two note types that already come with the game"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/unlockstrumlines.png"} alt="The two note types that already come with the game"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/addstrumline.png"} alt="The two note types that already come with the game"/>
</div>
...
<div style="display: flex;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/editstrumline.png"} alt="The two note types that already come with the game"/>
</div>
...
<div style="display: flex; justify-content: center;">
	<img src={import.meta.env.BASE_URL+"wiki/images/editors/chart/editstrumlinemenu.png"} alt="The two note types that already come with the game"/>
</div>
