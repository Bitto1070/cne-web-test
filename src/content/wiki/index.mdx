...
<img class="arrow_thing desktop" src={import.meta.env.BASE_URL+'/'+"img/sidebar_pointer(1).png"}/>
<img class="arrow_thing mobile" src={import.meta.env.BASE_URL+'/'+"img/sidebar_pointer_mobile(1).png"}/>
