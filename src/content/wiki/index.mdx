...
<img class="arrow_thing desktop" src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"img/sidebar_pointer(1).png"}/>
<img class="arrow_thing mobile" src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"img/sidebar_pointer_mobile(1).png"}/>
...
If you wish to help contribute to the wiki, please visit the <a href="https://github.com/CodenameCrew/cne-web-test/">GitHub Repository</a> and contribute via pull requests.
</Note>

Credits:
- **Betopia** - some styling and basically making the entire structure of the website.
