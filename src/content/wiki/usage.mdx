...
<div style="display: flex; justify-content: center; gap: 25px;">
    <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/Options Menu.png"} alt="Options Menu" style="width:50%;"/>
    <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/Options - Gameplay.png"} alt="Gameplay Menu" style="width:50%;"/>
</div>
...
### Controls Menu
<img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/Options - Controls.png"} alt="Control Options Substate" style="width:85%;"/>
...
<img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/Mod Select Menu.png"} alt="Substate for Switching Mods" style="width:85%;"/>
...
<img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/FPS Counter.png"} alt="Substate for Switching Mods" style="width:50%;"/>
...
<img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/freeplay/1.png"} alt="Preview of FreeplayState" style="width:85%;"/>

## Gamemode Types
<div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 10px; justify-items: center;">
  <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/freeplay/2.png"} alt="Solo" style="width:100%;"/>
  <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/freeplay/3.png"} alt="Opponent Mode" style="width:100%;"/>
  <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/freeplay/4.png"} alt="Co-Op Mode" style="width:100%;"/>
  <img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/freeplay/5.png"} alt="Co-Op Mode (Switched)" style="width:100%;"/>
</div>
...
<img src={(import.meta.env.DEV?'':import.meta.env.BASE_URL)+'/'+"wiki/images/home/Developer Options.png"} alt="Developer Options" style="width:85%;"/>
